namespace Mapbox.Examples
{
	...
	public class QuadTreeCameraMovement : MonoBehaviour
	{
		...
		void MoveMapUsingTouch()
		{
			if (Input.touchCount == 1)
			{
				...
				if (touch.phase == TouchPhase.Moved)
				{
					...
					// _referenceCamera.transform.Translate(-touchDeltaPosition.x * _panSpeed, -touchDeltaPosition.y * _panSpeed, 0);
					_referenceCamera.transform.Translate(-touchDeltaPosition.x * _panSpeed, 0, -touchDeltaPosition.y * _panSpeed);
				}
			}
		}
		...
		void UseMeterConversion()
		{
			...
			// 	var mousePosScreen = new Vector3(touch.position.x, touch.position.y, 0);
			// 	mousePosScreen.z = _referenceCamera.transform.localPosition.y;
			// 	_mousePosition = _referenceCamera.ScreenToWorldPoint(mousePosScreen);
			...
			// 	{
			// 		_shouldDrag = true;
			// 		_origin = _referenceCamera.ScreenToWorldPoint(touch.position);
			// 	}
			// }
			else
			{
